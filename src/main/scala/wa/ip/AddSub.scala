...
object AddSubConfig {
    ...
    val add = "Add"
    val addSubtract = "Add_Subtract"
}

class AddSub(A_WIDTH: Int, B_WIDTH: Int, S_WIDTH: Int, A_TYPE: String, B_TYPE: String, ADD_MODE: String, clockDomain: ClockDomain, componentName: String)
  extends BlackBox {
    val io = new Bundle {
...
object AddSub {
    ...
    def apply(A_WIDTH: Int, B_WIDTH: Int, S_WIDTH: Int, A_TYPE: String, B_TYPE: String, PIPELINE_STAGE: Int, RESOURCES_TYPE: String, clockDomain: ClockDomain, ADD_MODE: String, componentName: String, genTclScript: Boolean = true) = {
        ...
        val addSub = new AddSub(A_WIDTH, B_WIDTH, S_WIDTH, A_TYPE, B_TYPE, ADD_MODE,clockDomain, componentName)
        addSub
    }
}
